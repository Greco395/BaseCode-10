...
/****************************************************************************/
/** This script is modifyed for work with BaseCode and will no work alone. **/
/****************************************************************************/
		...
		<div class="row p-3">
			...
			<div class="col-md-9">
				...
				<div class="float-right">
					<a href="./add_plugin.php" class="btn btn-sm btn-danger">Return to BaseCode</a>
				</div>
			</div>
		</div>
